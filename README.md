...
You should refer to the documentation of [proxy-client-react](https://github.com/Unleash/proxy-client-react) for more information on how to use the SDK. Simply replace the import statements from `@unleash/proxy-client-react` to `@unleash/unleash-react-native`.
